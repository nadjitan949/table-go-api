...
const getAllMenusServices = async (req, res) => {
    ...
    return res.status(responses.OK).json({
        success: true,
        message: menus.length === 0 ? "Aucun menu engregistré pour le moment" : "Liste des menus",
        data: menus
    })
}
...
module.exports = { getAllMenusServices, getOneMenuService, addMenuService, updateMenuService, deleteMenuService, disableMenuService, enableMenuService }