...
const { getAllMenusController, getOneMenuController, addMenuController, updateMenuController, deleteMenuController, disableMenuController, enableMenuController } = require("./menu.controller")
...
menuRoute.post("/add", menuPhotoUpload, uploadMenuPhoto, validate(addMenuItemSchema), addMenuController )
menuRoute.put("/update/:id", menuPhotoUpload, uploadMenuPhoto, validate(updateMenuItemSchema), updateMenuController )
